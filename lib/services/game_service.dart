...
class GameService {
  final List<Game> _games = [
    ...
    Game(
      ...
      videoUrl: '',
      platforms: [Platform.Xbox , Platform.PlayStation, Platform.PC, Platform.Switch],
    ),
    Game(
    ...
    Game(
      ...
      videoUrl: '', platforms: [Platform.PC, Platform.PlayStation, Platform.Xbox],
    ),
    Game(
      ...
      videoUrl: '', platforms: [Platform.Xbox, Platform.PC],
    ),
    Game(
      title: 'Mario Kart 8',
      ...
      videoUrl: '', platforms: [Platform.Switch],
    ),
    Game(
      ...
      videoUrl: '', platforms: [Platform.PlayStation, Platform.PC],
    ),
    Game(
